...
interface interface_SD_Meeting_Tool_Display_Formats
{
	/**
		...
		@wp_filter
		@param		$SD_Meeting_Tool_Display_Format		Display format to delete.
	**/
 	...
 	/**
		...
		@wp_filter
		@param		$SD_Meeting_Tool_Participant		Participant to display.
		@param		$SD_Meeting_Tool_Display_Format		Display format to use.
	...
	**/
	...
	/**
		...
		@wp_filter
		@param		$display_format_id				ID of a display format.
	...
	**/
	...
	/**
		...
		@wp_filter
		@param		$SD_Meeting_Tool_Display_Format		Display format to create or update.
